...
export function SortingSection(props: SortingSectionProps) {
    return (
        <Container>
            <Item isSelected={props.sortType === 'alphabet'} onClick={() => props.sortHolidays('alphabet')}>
            ...
            <Border />
            <Item isSelected={props.sortType === 'price'} onClick={() => props.sortHolidays('price')}>
            ...
            <Border />
            <Item isSelected={props.sortType === 'stars'} onClick={() => props.sortHolidays('stars')}>
